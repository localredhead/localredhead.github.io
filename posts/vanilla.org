...
:END:
Just Use the defaults to their fullest.

If you cover everything with chocolate and sprinkles, how will you notice the sublime flavor of a good vanilla ice-cream?
** Design intent
:PROPERTIES:
...
:END:
Even with you're food, someone designed the flavor.

The difference between liking something versus adoring it has a lot to do with design and empathy for the users of it.

So why do people see it upon themselves to subvert the intent of a designer by customizing the experience to their own desires?
...
:END:
With every change an opportunity for entropy presents itself.  Eventually these modifications accumulate and diminish the will of the designer.  Or dilute the flavor, if you're still following the analogy from before.
...
A younger me would respond with "be you're own designer".  I find the task of design both fulfilling and incredibly difficult.   For myself it shall always be a hobby and I would tell my younger self:

#+BEGIN_QUOTE
Settle into my ways of working smarter, not harder.
#+END_QUOTE

I've had a mentor or three say this to me over the years.  Stubborn is one adjective I can safely brandish.  Hopefully this post will serve as a reminder to my future self.
** Beat Entropy
:PROPERTIES:
...
I'm applying my lessons learned, and converging back to simplicity.
